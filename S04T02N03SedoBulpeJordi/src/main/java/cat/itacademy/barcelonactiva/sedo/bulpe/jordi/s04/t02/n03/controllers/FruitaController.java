package cat.itacademy.barcelonactiva.sedo.bulpe.jordi.s04.t02.n03.controllers;
...
import cat.itacademy.barcelonactiva.sedo.bulpe.jordi.s04.t02.n03.services.FruitaService;
...
public class FruitaController {
	 ...
	 * Validacions diverses segons id, nom i qtt
	 * @param fruita
	 * @return
	 */
	...
	public ResponseEntity<?> afegirFruita(@RequestBody Fruita fruita){
        ...
        if(fruitaservice.existeixNom(fruita.getNom())){
