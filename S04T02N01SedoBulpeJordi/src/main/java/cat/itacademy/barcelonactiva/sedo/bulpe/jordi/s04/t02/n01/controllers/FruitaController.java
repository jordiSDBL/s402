package cat.itacademy.barcelonactiva.sedo.bulpe.jordi.s04.t02.n01.controllers;
...
import cat.itacademy.barcelonactiva.sedo.bulpe.jordi.s04.t02.n01.services.FruitaService;
...
public class FruitaController {
	...
	public ResponseEntity<?> detallarFruita(@PathVariable("idFruita") int idFruita) {
		...
		Fruita fruita = fruitaservice.mostrarFruita(idFruita);
	...
	public ResponseEntity<?> afegirFruita(@RequestBody Fruita fruita){
        ...
        fruita = new Fruita(fruita.getIdFruita(), fruita.getNom(), fruita.getQttQuilos());
	...
	public ResponseEntity<?> esborrarfruita(@PathVariable("idFruita") int idFruita ){
		...
		Fruita fruita = fruitaservice.mostrarFruita(idFruita);
		fruitaservice.esborrarFruita(idFruita);

		
		
		return new ResponseEntity<>(fruita.getNom() + " s'ha esborrat correctamet.", HttpStatus.OK);
	}
